...
$admin_db = mysqli_fetch_assoc($admin_query_db);
                ...
                <div class="row align-items-center">
                    <div class="col-xl-7 col-lg-6">
                        <div class="banner-content">
                            ...
                            <h2 class="wow fadeInUp" data-wow-delay="0.4s">I am <?= $_SESSION['auth_name'] ?></h2> 
                            ...
                            <div class="banner-social wow fadeInUp" data-wow-delay="0.8s">
                                <ul>
                                    ...
                                    <li><a href="<?= $admin_db['facebook'] ?>" target="blank"><i class="fab fa-facebook-f"></i></a></li>
                                    <li><a href="<?= $admin_db['twitter'] ?>" target="blank"><i class="fab fa-twitter"></i></a></li>
                                    <li><a href="<?= $admin_db['instagram'] ?>" target="blank"><i class="fab fa-instagram"></i></a></li>
                                    <li><a href="<?= $admin_db['linkedin'] ?>" target="blank"><i class="fab fa-pinterest"></i></a></li>
                                </ul>
                            </div>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6 pr-90">
                        <div class="section-title mb-25">
                            ...
                            <h2>About Me</h2>
                        <?php
                         $about_query = "SELECT * FROM about  LIMIT 4";
                         $about_query_db = mysqli_query($db_connect, $about_query);
                         $about_db = mysqli_fetch_assoc($about_query_db);
                        ?>
                        </div>
                        <div class="about-content">
                            <p><?=$about_db['about_me']?></p>
                            <h3>Skill:</h3>
                        </div>
                        <!-- Education Item -->
                        <?php
                        foreach ($about_query_db as  $about) : ?>
                            <div class="education">
                            <div class="year"><i class="<?=$about['skil_icon']?>"></i></div>
                            <div class="line"></div>
                            <div class="location">
                                <span><?=$about['skill_title']?></span>
                                <div class="progressWrapper">
                                    <div class="progress">
                                        <div class="progress-bar wow slideInLefts" data-wow-delay="0.2s" data-wow-duration="2s" role="progressbar" style="width: <?=$about['skill_persent']?>%;" aria-valuenow="65" aria-valuemin="0" aria-valuemax="100"></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-xl-2 col-lg-3 col-sm-6">
                                <div class="fact-box text-center mb-50">
                                    <div class="facts-icon">
                                        <i class="fa-2x mb-2 <?= $fact['facts_icon'] ?>"></i>
                                    </div>
                                    <div class="fact-content">
                                        <h2><span class="count"><?= $fact['facts_count'] ?></span></h2>
                                        <span><?= $fact['facts_title'] ?></span>
                                    </div>
                                </div>
                            </div>
                        <?php
                            ...
                            ?>
                                <div class="single-testimonial text-center">
                                    <div class="testi-avatar">
                                        <img style="height: 80px; width: 80px;" src="../daseboard/upload/testimonials/<?= $testi['image'] ?>" alt="img">
                                    </div>
            ...
            <div class="container">
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6">
                        ...
                        <form action="../daseboard/message.php" method="POST">
